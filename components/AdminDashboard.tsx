...
import { Briefcase, TrendingUp, Activity, Loader2, AlertTriangle, BarChart2, LogOut } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            <div className="flex items-center justify-between">
                ...
                <button 
                    onClick={onLogout}
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-secondary hover:bg-destructive hover:text-white transition-colors text-sm font-medium"
                >
